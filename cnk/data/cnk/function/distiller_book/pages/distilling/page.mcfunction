$dialog show @s { \
  ...
  "body": [ \
    { \
      ...
      "width": 211, \
      "contents": [{ \
            "translate":"book.cnk.distilling_page","font":"cnk.book:base","shadow_color":0,"color":"white","with":[ \
                {"translate":"book.cnk.distilling_page.title","color":"#7b613a","font":"minecraft:default"}, \
