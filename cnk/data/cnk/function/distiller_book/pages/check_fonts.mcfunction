execute if data storage cnk:temp register.ingredients[0] run function cnk:distiller_book/pages/check_font with storage cnk:temp register.ingredients[0]
...
execute if data storage cnk:temp register.ingredients[1] run function cnk:distiller_book/pages/check_font with storage cnk:temp register.ingredients[1]
...
execute if data storage cnk:temp register.ingredients[2] run function cnk:distiller_book/pages/check_font with storage cnk:temp register.ingredients[2]
...
execute if data storage cnk:temp register.ingredients[3] run function cnk:distiller_book/pages/check_font with storage cnk:temp register.ingredients[3]
...
execute if data storage cnk:temp register.ingredients[4] run function cnk:distiller_book/pages/check_font with storage cnk:temp register.ingredients[4]
