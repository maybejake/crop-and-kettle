execute if data storage cnk:admin settings{diving_wine:true} run return fail
...
data modify storage cnk:temp register.page_name set value "item.cnk.diving_wine"
data modify storage cnk:temp register.ingredients set value [ \
    ...
    {key:"item.minecraft.prismarine_shard", font:"cnk.book:icons"}, \
    {key:"item.minecraft.pufferfish", font:"cnk.book:icons"}, \
]
