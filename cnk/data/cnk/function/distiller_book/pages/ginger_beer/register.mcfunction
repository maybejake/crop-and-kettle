execute if data storage cnk:admin settings{ginger_beer_disabled:true} run return fail
...
data modify storage cnk:temp register.page_name set value "item.cnk.ginger_beer"
