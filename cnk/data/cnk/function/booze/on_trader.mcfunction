...
execute if predicate {type:"minecraft:entity_properties",entity:"this",predicate:{periodic_tick:10}} run function cnk:booze/tick_10
...
execute if predicate {type:"minecraft:all_of",terms:[{type:"minecraft:entity_properties",entity:"this",predicate:{periodic_tick:40}},{type:"minecraft:random_chance",chance:0.6}]} at @s run playsound cnk:entity.booze.idle hostile @a ~ ~ ~ 1 1
execute if predicate {type:"minecraft:all_of",terms:[{type:"minecraft:entity_properties",entity:"this",predicate:{periodic_tick:30}},{type:"minecraft:random_chance",chance:0.5}]} at @s run playsound cnk:entity.booze.bubble hostile @a ~ ~ ~ 1 1
...
execute on passengers if entity @s[type=minecraft:item_display,tag=cnk.booze_bottle] run item modify entity @s contents {"type":"minecraft:set_custom_model_data","flags":{"mode":"replace_section","size":1,"offset":0,"values":[false]}}
