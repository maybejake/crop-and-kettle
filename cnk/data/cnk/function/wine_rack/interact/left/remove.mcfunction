...
data modify entity @n[type=minecraft:item_display,tag=cnk.wine_rack_temp] item set from entity @s item.components."minecraft:bundle_contents"[{components:{"minecraft:custom_data":{"cnk":{"wine_rack":{"slot":2b}}}}}]
