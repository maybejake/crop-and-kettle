...
data modify entity @n[type=minecraft:item_display,tag=cnk.wine_rack_temp] item set from entity @s item.components."minecraft:bundle_contents"[{components:{"minecraft:custom_data":{"cnk":{"wine_rack":{"slot":0b}}}}}]
...
item replace entity @p[tag=cnk.interact_wine_rack,distance=..20] weapon.mainhand from entity @n[type=minecraft:item_display,tag=cnk.wine_rack_temp] contents
kill @n[type=minecraft:item_display,tag=cnk.wine_rack_temp]

data remove entity @s item.components."minecraft:bundle_contents"[{components:{"minecraft:custom_data":{"cnk":{"wine_rack":{"slot":0b}}}}}]
