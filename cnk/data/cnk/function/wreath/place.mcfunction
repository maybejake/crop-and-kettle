...
execute positioned ~ ~0.1 ~ run execute as @n[type=minecraft:item_display,tag=cnk.wreath,distance=..0.1] at @s positioned ^ ^ ^-1 if block ~ ~ ~ #minecraft:doors[open=false] run return run function cnk:wreath/door/main
