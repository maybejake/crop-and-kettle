data modify storage cnk:temp cooking_pot.slot set from storage cnk:temp cooking_pot.Items[{components:{"minecraft:custom_data":{cnk:{ingredient:{type:"honey-glazed_ham"}}}}}].Slot
...
loot spawn ~ ~0.25 ~ loot cnk:food/festive_meal
