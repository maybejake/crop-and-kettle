...
# blink both
execute if score $chance cnk.dummy matches 1..6 run return run item modify entity @s armor.head {"function":"minecraft:set_custom_model_data","flags":{"mode":"replace_section","size":2,"offset":1,"values":[true, true]}}
