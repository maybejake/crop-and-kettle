...
execute if data storage cnk:temp cooking_pot.Items[{components:{"minecraft:custom_data":{cnk:{ingredient:{generic:["salmon"]}}}}}] run scoreboard players add $salmon_count cnk.dummy 1
