...
execute if data storage cnk:temp cooking_pot.Items[{components:{"minecraft:custom_data":{cnk:{ingredient:{generic:["mutton"]}}}}}] run scoreboard players add $mutton_count cnk.dummy 1
