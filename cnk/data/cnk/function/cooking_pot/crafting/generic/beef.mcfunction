...
execute if data storage cnk:temp cooking_pot.Items[{components:{"minecraft:custom_data":{cnk:{ingredient:{generic:["beef"]}}}}}] run scoreboard players add $beef_count cnk.dummy 1
