...
execute if data storage cnk:temp cooking_pot.Items[{components:{"minecraft:custom_data":{cnk:{ingredient:{generic:["mushroom"]}}}}}] run scoreboard players add $mushroom_count cnk.dummy 1
