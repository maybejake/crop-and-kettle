...
execute if data storage cnk:temp cooking_pot.Items[{components:{"minecraft:custom_data":{cnk:{ingredient:{generic:["pork"]}}}}}] run scoreboard players add $pork_count cnk.dummy 1
