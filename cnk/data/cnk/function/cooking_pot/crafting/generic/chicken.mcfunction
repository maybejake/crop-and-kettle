...
execute if data storage cnk:temp cooking_pot.Items[{components:{"minecraft:custom_data":{cnk:{ingredient:{generic:["chicken"]}}}}}] run scoreboard players add $chicken_count cnk.dummy 1
