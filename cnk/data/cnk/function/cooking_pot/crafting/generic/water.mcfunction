...
execute if data storage cnk:temp cooking_pot.Items[{components:{"minecraft:custom_data":{cnk:{ingredient:{generic:["water"]}}}}}] run scoreboard players add $water_count cnk.dummy 1
