...
execute if data storage cnk:temp cooking_pot.Items[{components:{"minecraft:custom_data":{cnk:{ingredient:{generic:["fruit"]}}}}}] run scoreboard players add $fruit_count cnk.dummy 1
