...
execute unless data storage cnk:temp meat_guide.map{id:"minecraft:filled_map"} run data remove storage cnk:temp meat_guide.item.components."minecraft:lodestone_tracker"
