...
execute if data storage cnk:temp mixing_bowl.Items[{components:{"minecraft:custom_data":{cnk:{ingredient:{generic:["ice"]}}}}}] run scoreboard players add $ice_count cnk.dummy 1
