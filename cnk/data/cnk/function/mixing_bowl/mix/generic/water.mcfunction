...
execute if data storage cnk:temp mixing_bowl.Items[{components:{"minecraft:custom_data":{cnk:{ingredient:{generic:["water"]}}}}}] run scoreboard players add $water_count cnk.dummy 1
