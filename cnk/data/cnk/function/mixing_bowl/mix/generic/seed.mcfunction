...
execute if data storage cnk:temp mixing_bowl.Items[{components:{"minecraft:custom_data":{cnk:{ingredient:{generic:["seed"]}}}}}] run scoreboard players add $seed_count cnk.dummy 1
