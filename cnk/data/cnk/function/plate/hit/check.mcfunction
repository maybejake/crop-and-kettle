...
execute if score $hit_plate_check cnk.dummy matches 1 on vehicle on passengers if entity @s[type=minecraft:item_display,tag=cnk.plate_item] on vehicle run return run function cnk:plate/hit/remove_last
