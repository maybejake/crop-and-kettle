...
execute if score $hit_calendar_check cnk.dummy matches 1 on vehicle at @s run particle minecraft:item{item:{id:"minecraft:barrier",components:{"minecraft:item_model":"cnk:calendar"}}} ^ ^0.5 ^-0.2 0.15 0.2 0.15 0.1 5