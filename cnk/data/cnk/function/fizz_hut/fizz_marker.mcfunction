...
# Handle home data
data modify entity @n[type=minecraft:villager,tag=cnk.fizz_trader,distance=..1] home_radius set value 15
data modify entity @n[type=minecraft:villager,tag=cnk.fizz_trader,distance=..1] home_pos set from storage cnk:temp fizz_hut.home_pos