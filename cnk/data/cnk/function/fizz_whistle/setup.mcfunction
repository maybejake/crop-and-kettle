...
execute at @s align xyz positioned ~0.5 ~ ~0.5 run tag @n[type=minecraft:villager,tag=cnk.fizz_trader,dx=0] add cnk.fizz_whistled
execute at @s align xyz positioned ~0.5 ~ ~0.5 run scoreboard players set @n[type=minecraft:villager,tag=cnk.fizz_trader,dx=0] cnk.fizz_timer 12000
