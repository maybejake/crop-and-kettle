...
execute if score @s cnk.candy_count matches 55.. run return run data modify entity @s item.components."minecraft:item_model" set value "cnk:candy_bowl/7"
data modify entity @s item.components."minecraft:item_model" set value "cnk:candy_bowl/0"