...
execute if items entity @p[tag=cnk.interact_candy_bowl] weapon.mainhand minecraft:poisonous_potato[minecraft:custom_data~{cnk:{candy:{}}}] on vehicle unless score @s cnk.candy_count matches 64.. at @s run return run function cnk:candy_bowl/item/add