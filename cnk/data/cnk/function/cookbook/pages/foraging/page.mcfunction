$dialog show @s { \
  ...
  "body": [ \
    { \
      ...
      "width": 211, \
      "contents": [{ \
            "translate":"book.cnk.foraging_page","font":"cnk.book:base","shadow_color":0,"color":"white","with":[ \
                {"translate":book.cnk.foraging_page.title,"color":"#7b613a","font":"minecraft:default"}, \
                ...
                {"translate":book.cnk.cookbook_navigation,"with":[{"translate":book.cnk.previous_page,"hover_event":{"action":"show_text","value":{"translate":book.cnk.previous_page.hover}},"click_event":{"action":"run_command","command":"trigger cnk.cookbook_buttons set 9901"}},{"translate":$(previous_incomplete_recipe)},{"translate":book.cnk.no_source,"font":"cnk.book:base"},{"translate":$(next_incomplete_recipe)},{"translate":book.cnk.next_page,"hover_event":{"action":"show_text","value":{"translate":book.cnk.next_page.hover}},"click_event":{"action":"run_command","command":"trigger cnk.cookbook_buttons set 9902"}}]} \
            ] \
        }] \
    }, \
    { \
