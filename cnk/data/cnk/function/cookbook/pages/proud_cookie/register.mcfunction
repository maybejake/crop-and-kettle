...
data modify storage cnk:temp register.page_name set value "item.cnk.proud_cookie"
...
data modify storage cnk:temp register.ingredients set value [ \
    ...
    {key:"item.minecraft.green_dye", font:"cnk.book:icons"}, \
    {key:"item.minecraft.blue_dye", font:"cnk.book:icons"}, \
    {key:"item.minecraft.yellow_dye", font:"cnk.book:icons"}, \
