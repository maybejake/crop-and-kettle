...
data modify storage cnk:temp register.page_name set value "item.cnk.nachos"
...
data modify storage cnk:temp register.ingredients set value [ \
    {key:"item.cnk.tortilla_chips", font:"cnk.book:icons"}, \
    {key:"item.cnk.salsa", font:"cnk.book:icons"}, \
    {key:"item.cnk.any_meat", font:"cnk.book:icons"}, \
    {key:"item.cnk.cheese", font:"cnk.book:icons"}, \
    {key:"item.cnk.chili", font:"cnk.book:icons"}, \
]
