...
data modify storage cnk:temp register.page_name set value "item.cnk.stone_soup"
...
data modify storage cnk:temp register.ingredients set value [ \
    {key:"item.cnk.vegetable_soup", font:"cnk.book:icons"}, \
    {key:"block.minecraft.stone", font:"cnk.book:icons"}, \
]
