...
execute store result score $check_flag cnk.dummy run function cnk:cookbook/check_flag with storage cnk:temp cookbook.ingredient
execute if score $check_flag cnk.dummy matches 0 unless data storage cnk:temp cookbook.current_page.static_title run tag @s add cnk.on_incomplete_page
