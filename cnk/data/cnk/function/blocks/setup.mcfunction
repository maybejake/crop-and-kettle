...
execute if block ~ ~-1 ~ #minecraft:trapdoors[half=bottom,open=false] positioned ~ ~-0.8125 ~ run return run function cnk:blocks/switch
execute if block ~ ~-1 ~ #cnk:carpets positioned ~ ~-0.9375 ~ run return run function cnk:blocks/switch
execute if block ~ ~-1 ~ #minecraft:slabs[type=bottom] positioned ~ ~-0.5 ~ run return run function cnk:blocks/switch
