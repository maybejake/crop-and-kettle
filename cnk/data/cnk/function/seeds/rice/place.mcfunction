...
# setup data
execute align xyz positioned ~0.5 ~ ~0.5 as @n[type=minecraft:item_display,tag=cnk.rice_crop,distance=..0.1] run function cnk:seeds/rice/setup