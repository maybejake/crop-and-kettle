...
execute if entity @p[tag=cnk.interact_cutting_board,distance=..20,tag=cnk.cutting_board_offhand] run item replace entity @s contents from entity @p[tag=cnk.interact_cutting_board,distance=..20] weapon.offhand
execute if entity @p[tag=cnk.interact_cutting_board,distance=..20,tag=!cnk.cutting_board_offhand] run item replace entity @s contents from entity @p[tag=cnk.interact_cutting_board,distance=..20] weapon.mainhand
execute at @s rotated as @n[type=minecraft:item_display,tag=cnk.cutting_board] run rotate @s ~ ~
