...
# remove
execute if entity @p[tag=cnk.interact_picnic_basket,distance=..20,predicate=!cnk:sneaking] run function cnk:picnic_basket/remove/one
execute if entity @p[tag=cnk.interact_picnic_basket,distance=..20,predicate=cnk:sneaking] run function cnk:picnic_basket/remove/stack
