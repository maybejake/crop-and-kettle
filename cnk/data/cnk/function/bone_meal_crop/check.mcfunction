...
execute if score $bonemeal_crop_check cnk.dummy matches 1 on vehicle if entity @n[type=minecraft:item_display,tag=cnk.crop] at @s run function cnk:bone_meal_crop/switch