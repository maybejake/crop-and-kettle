...
execute unless entity @s[tag=!cnk.tomato_crop,tag=!cnk.coffee_crop,tag=!cnk.chili_pepper_crop,tag=!cnk.grape_crop] if score @s cnk.age >= @s cnk.max_age run return run function cnk:bone_meal_crop/interact
...
function cnk:bone_meal_crop/particle/main
