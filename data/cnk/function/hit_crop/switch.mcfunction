...
execute if entity @s[tag=cnk.grape_crop] run return run function cnk:crops/grape/break
execute if entity @s[tag=cnk.lettuce_crop] run return run function cnk:crops/lettuce/break
