...
scoreboard players set @n[type=minecraft:item_display,tag=cnk.calendar] cnk.hit_count 0
scoreboard players set @n[type=minecraft:item_display,tag=cnk.calendar] cnk.hit_timer 0
