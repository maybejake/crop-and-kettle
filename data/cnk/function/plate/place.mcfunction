...
function cnk:plate/macro with storage cnk:temp
scoreboard players set @n[type=minecraft:item_display,tag=cnk.plate] cnk.hit_count 0
scoreboard players set @n[type=minecraft:item_display,tag=cnk.plate] cnk.hit_timer 0
scoreboard players set @n[type=minecraft:item_display,tag=cnk.plate] cnk.item_count 0