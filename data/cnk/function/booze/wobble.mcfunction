...
data modify entity @s[tag=cnk.wobbled] transformation.translation[1] set value 0.0
...
execute if score $wobble_chance cnk.dummy matches 2 run data modify entity @s[tag=!cnk.wobbled] transformation.translation[1] set value -0.4
