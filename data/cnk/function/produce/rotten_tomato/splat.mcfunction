...
execute if entity @s[tag=cnk.very_rotten] as @e[type=!minecraft:marker,distance=..3,tag=!smithed.block,tag=!smithed.entity,tag=!smithed.strict] run damage @s 5 minecraft:explosion
