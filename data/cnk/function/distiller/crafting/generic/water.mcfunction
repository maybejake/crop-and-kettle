...
execute if data storage cnk:temp distiller.Items[{components:{"minecraft:custom_data":{cnk:{pail:{liquid:"water"}}}}}] run scoreboard players add $water_count cnk.dummy 1
