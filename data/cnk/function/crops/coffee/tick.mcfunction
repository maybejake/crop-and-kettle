...
execute if score @s cnk.age matches 1 positioned ~ ~-0.5625 ~ as @n[type=minecraft:interaction,tag=cnk.crop_interaction,distance=..0.1] run return run data modify entity @s height set value 0.8125
...
execute if score @s cnk.age matches 3 positioned ~ ~-0.5625 ~ as @n[type=minecraft:interaction,tag=cnk.crop_interaction,distance=..0.1] run return run data modify entity @s height set value 1.25
...
execute if score @s cnk.age matches 4 positioned ~ ~-0.5625 ~ as @n[type=minecraft:interaction,tag=cnk.crop_interaction,distance=..0.1] run return run data modify entity @s height set value 1.4375
...
execute if score @s cnk.age matches 5 positioned ~ ~-0.5625 ~ as @n[type=minecraft:interaction,tag=cnk.crop_interaction,distance=..0.1] run return run data modify entity @s height set value 1.8125
