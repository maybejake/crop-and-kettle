...
kill @n[type=minecraft:item,nbt={Age:0s,Item:{id:"minecraft:mangrove_propagule"}},distance=..1]
kill @n[type=minecraft:item,nbt={Age:1s,Item:{id:"minecraft:mangrove_propagule"}},distance=..1]
