...
data modify storage cnk:temp register.page_name set value "item.cnk.festive_meal"
...
data modify storage cnk:temp register.ingredients set value [ \
    {key:"item.cnk.honey-glazed_ham", font:"cnk.book:icons"}, \
    {key:"item.minecraft.potato", font:"cnk.book:icons"}, \
    {key:"item.minecraft.carrot", font:"cnk.book:icons"}, \
