    ...
    { \
      ...
      "contents": [{ \
            "translate":"book.cnk.kebab_sword","font":"cnk.book:base","shadow_color":0,"color":"white","with":[ \
                ...
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.$(slot_1),"font":"$(font_1)"}],"hover_event":{"action":"show_text","value":[{"translate":$(slot_1)},{"translate":book.cnk.hyperlink,"font":"cnk.book:base"}]},"click_event":{"action":"run_command","command":"trigger cnk.cookbook_buttons set 9911"}}, \
