...
data modify storage cnk:temp register.page_name set value "item.cnk.ramen"
...
data modify storage cnk:temp register.ingredients set value [ \
    {key:"item.cnk.noodles", font:"cnk.book:icons"}, \
    ...
    {key:"item.minecraft.dried_kelp", font:"cnk.book:icons"}, \
]
