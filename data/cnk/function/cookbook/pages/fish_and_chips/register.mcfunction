...
data modify storage cnk:temp register.page_name set value "item.cnk.fish_and_chips"
...
data modify storage cnk:temp register.ingredients set value [ \
    {key:"item.cnk.fries", font:"cnk.book:icons"}, \
    {key:"item.cnk.fried_fish", font:"cnk.book:icons"}, \
]
