...
data modify storage cnk:temp register.page_name set value "item.cnk.burrito_box"
...
data modify storage cnk:temp register.ingredients set value [ \
    {key:"item.cnk.burrito", font:"cnk.book:icons"}, \
    {key:"item.cnk.chips_and_dip", font:"cnk.book:icons"}, \
]
