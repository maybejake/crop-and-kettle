...
data modify storage cnk:temp register.page_name set value "item.cnk.thankful_meal"
...
data modify storage cnk:temp register.ingredients set value [ \
    {key:"item.cnk.cornbread", font:"cnk.book:icons"}, \
    {key:"item.cnk.mac_and_cheese", font:"cnk.book:icons"}, \
