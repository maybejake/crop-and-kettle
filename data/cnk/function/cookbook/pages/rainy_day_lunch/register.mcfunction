...
data modify storage cnk:temp register.page_name set value "item.cnk.rainy_day_lunch"
...
data modify storage cnk:temp register.ingredients set value [ \
    {key:"item.cnk.grilled_cheese", font:"cnk.book:icons"}, \
    {key:"item.cnk.tomato_soup", font:"cnk.book:icons"}, \
]
