...
data modify storage cnk:temp register.page_name set value "item.cnk.iced_coffee"
...
data modify storage cnk:temp register.ingredients set value [ \
    ...
    {key:"item.cnk.coffee", font:"cnk.book:icons"}, \
    {key:"item.minecraft.cocoa_beans", font:"cnk.book:icons"}, \
