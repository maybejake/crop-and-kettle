...
data modify storage cnk:temp register.page_name set value "item.cnk.steak_and_ale_pie"
...
data modify storage cnk:temp register.ingredients set value [ \
    {key:"item.cnk.beer", font:"cnk.book:icons"}, \
    {key:"item.cnk.beef_cutlets", font:"cnk.book:icons"}, \
