...
data modify storage cnk:temp register.page_name set value "item.cnk.ginger_chicken"
...
data modify storage cnk:temp register.ingredients set value [ \
    {key:"item.cnk.ginger", font:"cnk.book:icons"}, \
    {key:"item.minecraft.chicken", font:"cnk.book:icons"}, \
    {key:"item.cnk.rice", font:"cnk.book:icons"}, \
    {key:"item.cnk.chili_pepper", font:"cnk.book:icons"}, \
    {key:"item.minecraft.honey_bottle", font:"cnk.book:icons"}, \
]
