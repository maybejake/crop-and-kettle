...
scoreboard players operation $next_page cnk.dummy = $desserts_page cnk.dummy
function cnk:cookbook/buttons/check_incomplete_recipe/main

scoreboard players operation @s cnk.cookbook_current_page = $desserts_page cnk.dummy
