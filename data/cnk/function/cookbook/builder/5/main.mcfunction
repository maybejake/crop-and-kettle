...
data modify storage cnk:temp cookbook.ingredient.id set from storage cnk:temp cookbook.current_page.ingredients[3].key
data modify storage cnk:temp cookbook.ingredient.font set from storage cnk:temp cookbook.data.font_4
data modify storage cnk:temp cookbook.ingredient.flag set from storage cnk:temp cookbook.data.slot_4
data modify storage cnk:temp cookbook.ingredient.position set value 4
function cnk:cookbook/builder/resolve_ingredient with storage cnk:temp cookbook.ingredient
data modify storage cnk:temp cookbook.ingredient.4 set from storage cnk:temp cookbook.ingredient.output

data modify storage cnk:temp cookbook.ingredient.id set from storage cnk:temp cookbook.current_page.ingredients[4].key
data modify storage cnk:temp cookbook.ingredient.font set from storage cnk:temp cookbook.data.font_5
data modify storage cnk:temp cookbook.ingredient.flag set from storage cnk:temp cookbook.data.slot_5
data modify storage cnk:temp cookbook.ingredient.position set value 5
function cnk:cookbook/builder/resolve_ingredient with storage cnk:temp cookbook.ingredient
data modify storage cnk:temp cookbook.ingredient.5 set from storage cnk:temp cookbook.ingredient.output

function cnk:cookbook/builder/5/merge with storage cnk:temp cookbook.ingredient