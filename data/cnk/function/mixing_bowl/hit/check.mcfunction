...
execute if score $hit_mixing_bowl_check cnk.dummy matches 1 on vehicle on passengers if entity @s[type=minecraft:item_display,tag=cnk.mixing_bowl_item] on vehicle run return run function cnk:mixing_bowl/hit/remove_last
