...
data modify storage cnk:temp register.page_name set value "item.cnk.breezing_wine"
data modify storage cnk:temp register.ingredients set value [ \
    ...
    {key:"item.minecraft.wind_charge", font:"cnk.book:icons"}, \
    {key:"item.minecraft.feather", font:"cnk.book:icons"}, \
]
