...
data modify storage cnk:temp register.page_name set value "item.cnk.heroic_wine"
data modify storage cnk:temp register.ingredients set value [ \
    ...
    {key:"block.minecraft.emerald_block", font:"cnk.book:icons"}, \
    {key:"item.minecraft.totem_of_undying", font:"cnk.book:icons"}, \
]
