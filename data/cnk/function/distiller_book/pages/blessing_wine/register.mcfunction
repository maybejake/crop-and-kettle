...
data modify storage cnk:temp register.page_name set value "item.cnk.blessing_wine"
data modify storage cnk:temp register.ingredients set value [ \
    ...
    {key:"item.minecraft.rabbit_foot", font:"cnk.book:icons"}, \
    {key:"block.minecraft.gold_block", font:"cnk.book:icons"}, \
]
