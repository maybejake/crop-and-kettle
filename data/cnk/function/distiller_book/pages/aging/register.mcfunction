...
data modify storage cnk:temp register.page_name set value "aging"
data modify storage cnk:temp register.dialog_function set value "cnk:distiller_book/pages/aging/page"
