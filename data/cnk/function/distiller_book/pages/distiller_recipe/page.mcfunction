    ...
    { \
      ...
      "contents": [{ \
            "translate":"book.cnk.distiller_crafting","font":"cnk.book:base","shadow_color":0,"color":"white","with":[ \
                {"translate":"item.cnk.distiller","color":"#7b613a","font":"minecraft:default"}, \
                {"translate":"book.cnk.paragraph_1"}, \
                ...
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.item.minecraft.iron_ingot,"font":"cnk.book:icons"}],"hover_event":{"action":"show_text","value":{"translate":item.minecraft.iron_ingot}}}, \
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.item.minecraft.compass,"font":"cnk.book:icons"}],"hover_event":{"action":"show_text","value":{"translate":item.minecraft.compass}}}, \
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.block.minecraft.copper_block,"font":"cnk.book:icons"}],"hover_event":{"action":"show_text","value":{"translate":block.minecraft.copper_block}}}, \
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.item.minecraft.iron_ingot,"font":"cnk.book:icons"}],"hover_event":{"action":"show_text","value":{"translate":item.minecraft.iron_ingot}}}, \
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.item.cnk.blank,"font":"cnk.book:icons"}]}, \
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.block.minecraft.barrel,"font":"cnk.book:icons"}],"hover_event":{"action":"show_text","value":{"translate":block.minecraft.barrel}}}, \
                {"translate":book.cnk.ingredient_template,with:[{"translate":book.item.cnk.blank,"font":"cnk.book:icons"}]}, \
