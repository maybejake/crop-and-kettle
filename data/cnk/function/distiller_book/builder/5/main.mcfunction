...
data modify storage cnk:temp distiller_book.ingredient.flag set from storage cnk:temp distiller_book.data.slot_5
data modify storage cnk:temp distiller_book.ingredient.font set from storage cnk:temp distiller_book.data.font_5
function cnk:distiller_book/builder/resolve_ingredient with storage cnk:temp distiller_book.ingredient
data modify storage cnk:temp distiller_book.ingredient.5 set from storage cnk:temp distiller_book.ingredient.output

function cnk:distiller_book/builder/5/merge with storage cnk:temp distiller_book.ingredient