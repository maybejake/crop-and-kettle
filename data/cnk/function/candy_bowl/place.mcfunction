...
function cnk:candy_bowl/macro with storage cnk:temp
scoreboard players set @n[type=minecraft:item_display,tag=cnk.candy_bowl] cnk.hit_count 0
scoreboard players set @n[type=minecraft:item_display,tag=cnk.candy_bowl] cnk.hit_timer 0
scoreboard players set @n[type=minecraft:item_display,tag=cnk.candy_bowl] cnk.item_count 0
scoreboard players set @n[type=minecraft:item_display,tag=cnk.candy_bowl] cnk.candy_count 0