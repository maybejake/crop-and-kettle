...
execute if items entity @s weapon.offhand *[minecraft:custom_data~{cnk:{seed:true}}] run data modify storage cnk:temp seeds.hand set value "offhand"
execute if items entity @s weapon.mainhand *[minecraft:custom_data~{cnk:{seed:true}}] run data modify storage cnk:temp seeds.hand set value "mainhand"
