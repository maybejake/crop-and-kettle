...
execute unless block ~ ~ ~ #cnk:air run return run function cnk:seeds/grape/summon {count:1}
execute unless block ~ ~1 ~ #cnk:air run return run function cnk:seeds/grape/summon {count:1}
