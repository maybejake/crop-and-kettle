          ...
          "functions": [ \
            { \
              ...
              "components": { \
                ...
                "minecraft:item_name": {"translate":"item.cnk.apple_cider","fallback":"Apple Cider"}, \
                "minecraft:item_model": "cnk:apple_cider", \
                "minecraft:food": { \
                  "nutrition": 0, \
                  "saturation": 0, \
                  "can_always_eat": true \
                ...
                "minecraft:custom_data": {"cnk":{"ingredient":{"type":"apple_cider"},"wine":{"time":$(gametime),"color":$(color)}},"smithed":{"ignore":{"functionality":true,"crafting":true}}}, \
