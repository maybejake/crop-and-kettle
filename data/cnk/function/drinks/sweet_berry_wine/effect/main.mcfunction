...
execute store result storage cnk:temp sweet_berry_wine.duration int 1 run scoreboard players get $duration cnk.dummy
execute at @s run function cnk:drinks/sweet_berry_wine/effect/effect with storage cnk:temp sweet_berry_wine