          ...
          "functions": [ \
            { \
              ...
              "components": { \
                ...
                "minecraft:item_name": {"translate":"item.cnk.blazing_wine","fallback":"Blazing Wine"}, \
                "minecraft:item_model": "cnk:blazing_wine", \
                "minecraft:food": { \
                  "nutrition": 0, \
                  "saturation": 0, \
                  "can_always_eat": true \
                ...
                "minecraft:custom_data": {"cnk":{"ingredient":{"type":"blazing_wine"},"wine":{"time":$(gametime),"color":$(color)}},"smithed":{"ignore":{"functionality":true,"crafting":true}}}, \
