          ...
          "functions": [ \
            { \
              ...
              "components": { \
                ...
                "minecraft:item_name": {"translate":"item.cnk.chorus_wine","fallback":"Chorus Wine"}, \
                "minecraft:item_model": "cnk:chorus_wine", \
                "minecraft:food": { \
                  "nutrition": 0, \
                  "saturation": 0, \
                  "can_always_eat": true \
                ...
                "minecraft:custom_data": {"cnk":{"ingredient":{"type":"chorus_wine"},"wine":{"time":$(gametime),"color":$(color)}},"smithed":{"ignore":{"functionality":true,"crafting":true}}}, \
