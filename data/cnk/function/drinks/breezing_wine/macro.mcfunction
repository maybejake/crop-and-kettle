          ...
          "functions": [ \
            { \
              ...
              "components": { \
                ...
                "minecraft:item_name": {"translate":"item.cnk.breezing_wine","fallback":"Breezing Wine"}, \
                "minecraft:item_model": "cnk:breezing_wine", \
                "minecraft:food": { \
                  "nutrition": 0, \
                  "saturation": 0, \
                  "can_always_eat": true \
                ...
                "minecraft:custom_data": {"cnk":{"ingredient":{"type":"breezing_wine"},"wine":{"time":$(gametime),"color":$(color)}},"smithed":{"ignore":{"functionality":true,"crafting":true}}}, \
