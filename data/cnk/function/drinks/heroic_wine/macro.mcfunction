          ...
          "functions": [ \
            { \
              ...
              "components": { \
                ...
                "minecraft:item_name": {"translate":"item.cnk.heroic_wine","fallback":"Heroic Wine"}, \
                "minecraft:item_model": "cnk:heroic_wine", \
                "minecraft:food": { \
                  "nutrition": 0, \
                  "saturation": 0, \
                  "can_always_eat": true \
                ...
                "minecraft:custom_data": {"cnk":{"ingredient":{"type":"heroic_wine"},"wine":{"time":$(gametime),"color":$(color)}},"smithed":{"ignore":{"functionality":true,"crafting":true}}}, \
