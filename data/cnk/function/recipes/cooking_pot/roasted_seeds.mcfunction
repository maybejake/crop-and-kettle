data modify storage cnk:temp cooking_pot.slot set from storage cnk:temp cooking_pot.Items[{id:"minecraft:pumpkin_seeds"}].Slot
...
loot spawn ~ ~0.25 ~ loot cnk:food/roasted_seeds
