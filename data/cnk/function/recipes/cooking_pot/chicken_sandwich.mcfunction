...
data modify storage cnk:temp cooking_pot.slot set from storage cnk:temp cooking_pot.Items[{components:{"minecraft:custom_data":{cnk:{ingredient:{type:"sea_pickle"}}}}}].Slot
function cnk:recipes/remove with storage cnk:temp cooking_pot
